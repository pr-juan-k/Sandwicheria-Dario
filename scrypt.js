...
// ========================================
const WHATSAPP_NUMBER = '5493813408835'; // Formato: codigo pais + numero sin espacios ni guiones
...
const menuData = {
  promociones: {
    ...
    products: {
      ...
      promo5: {
        name: 'Promo 3 Milanesas de CARNE',
        price: 20000,
        promoCount: 3, // Cantidad de milanesas a preparar
        ingredients: ['tomate', 'lechuga', 'mayonesa', 'mostaza','aji'],
        image: 'images/milanesa.jpeg'
...
,
  milanesas: {
    ...
    products: {
      ...
      molida: {
        especial: {
          name: 'Milanesa Molida Super',
          price: 4500,
          ingredients: ['lechuga', 'tomate', 'mayonesa', 'mostaza', 'huevo','queso cheddar','jamon','huevo',  'papas fritas','aji'],
          image: 'images/milanesa-p.jpeg'
        }
      }
    }
  ...
  milanesaNapolitana: {
    ...
    products: {
      '1persona': {
        name: 'Napolitana 1 Persona Con Guarnicion',
        price: 9000,
        image: 'images/milanesa-napolitana.jpg',
        description: 'Al plato con papas fritas'
      },
      '2personas': {
        name: 'Napolitana 2 Personas Con Guarnicion',
        price: 20000,
        image: 'images/milanesa-napolitana.jpg',
        description: 'Al plato con papas fritas'
      }
  ...
  lomitos: {
    ...
    products: {
      ...
      especial: {
        ...
        price: 9000,
        ingredients: ['lechuga', 'tomate', 'mayonesa', 'mostaza', 'huevo','jamon','queso cheddar', 'papas fritas','aji'],
  ...
  hamburguesas: {
    ...
    products: {
      comun: {
        name: 'Hamburguesa clasica Comun',
        price: 5000,
        ingredients: ['lechuga', 'tomate', 'mayonesa', 'mostaza','aji'],
    ...
    hasVariety: true,
    varieties: ['promos','carne', 'pollo','mondongo'],
    isSimple: true,
    products: {
      promos: {
        '12_unidades-c': {
      ...
      mondongo: {
        '12_unidades': {
          name: 'Empanadas de Mondongo x12',
          price: 12000,
          image: 'images/empanada.jpg'
        }
      }
...
function sendWhatsApp() {
  ...
  const urlGoogleSheet = 'https://script.google.com/macros/s/AKfycbytUyMQFsLbK7vFka_hpe7px6AATxs8GQIuPULBm_emc-fKoPrkT77Y2akD0JYDwUjhNg/exec';
